...
public class DynamicRouteServiceImplByNacos {
    ...
    public void init() {
        ...
        try {
            ...
            System.out.println(GatewayConfig.NACOS_ROUTE_DATA_ID);
            System.out.println(GatewayConfig.NACOS_ROUTE_GROUP);
            System.out.println(GatewayConfig.DEFAULT_TIMEOUT);
